					...
					_createClass(NegociacaoDao, [
						...
						},
						{
							...
							value: function listaTodos() {
								...
								return new Promise(function (resolve, reject) {
									var cursor = _this2._connection
										.transaction([_this2._store], "readwrite")
										.objectStore(_this2._store)
										.openCursor();
						...
						},
						{
							...
							value: function apagaTodos() {
								...
								return new Promise(function (resolve, reject) {
									var request = _this3._connection
										.transaction([_this3._store], "readwrite")
										.objectStore(_this3._store)
										.clear();
